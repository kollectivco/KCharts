		...
		<div class="amc-container">
			<div class="amc-card-grid">
				<?php if ( $charts ) : ?>
					...
					<?php endforeach; ?>
				<?php else : ?>
					<p>No chart categories are active yet. Create the first chart, configure scoring, upload real source data, and publish the first live week from the KCharts dashboard.</p>
				<?php endif; ?>
			</div>
		</div>
	</section>
	...
	<section class="amc-section">
		<div class="amc-container amc-split">
			<div class="amc-panel">
				...
				<p>KCharts publishes chart weeks from real uploaded sources through parsing, validation, matching, generation, and final publishing review.</p>
