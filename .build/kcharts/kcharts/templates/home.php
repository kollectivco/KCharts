	...
	<section class="amc-home-hero">
		<div class="amc-container amc-home-hero__inner">
			<div class="amc-home-hero__copy">
				<p class="amc-section-label"><?php echo esc_html( $public_state['has_published_data'] ? 'Week of ' . wp_date( 'F j, Y' ) : 'KCharts' ); ?></p>
				...
				<?php elseif ( $public_state['has_charts'] ) : ?>
					...
					<p>Chart categories already exist. Publish the first live week from the KCharts dashboard to start filling this homepage with real rankings.</p>
				<?php else : ?>
					<h1>KCharts is ready for its first live chart week.</h1>
		...
		<div class="amc-container">
			...
			<div class="amc-card-grid">
				<?php if ( $context['featured_charts'] ) : ?>
					...
					<?php endforeach; ?>
				<?php else : ?>
					<p>No chart categories are active yet. Create the first real chart from the KCharts dashboard to start the onboarding flow.</p>
				<?php endif; ?>
			</div>
		</div>
	</section>
	...
	<section class="amc-section">
		<div class="amc-container amc-split">
			<div class="amc-panel">
				...
				<p>Explore real artists and tracks that have been added to KCharts, even before every chart route is fully populated with live weeks.</p>
				<div class="amc-home-hero__actions">
