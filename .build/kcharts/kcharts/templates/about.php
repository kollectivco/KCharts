...
<main class="amc-main">
	<section class="amc-page-hero">
		<div class="amc-container">
			...
			<h1>How KCharts moves from source data to a live chart week.</h1>
	...
	<section class="amc-section">
		<div class="amc-container amc-split">
			...
			<div class="amc-panel">
				...
				<p><?php echo esc_html( $settings['methodology_text'] ? $settings['methodology_text'] : 'Methodology text has not been published yet. Configure it from the KCharts settings and scoring workflow.' ); ?></p>
			</div>
		</div>
	</section>
</main>
