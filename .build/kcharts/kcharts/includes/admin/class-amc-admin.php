...
class AMC_Admin {
		...
		<div class="amc-custom-dashboard" data-amc-theme="dark">
			<div class="amc-custom-dashboard__sidebar">
				<div class="amc-custom-dashboard__brand">
					<span>KC</span>
					<div>
						<strong>KCharts</strong>
						<small>Main workspace</small>
					</div>
				</div>
				<nav class="amc-custom-dashboard__nav" aria-label="KCharts Dashboard Navigation">
			...
			<div class="amc-custom-dashboard__main">
				<header class="amc-admin-topbar amc-admin-topbar--dashboard">
					<div>
						<p class="amc-admin-kicker">KCharts</p>
	...
	private static function render_wp_admin_shell( $key, $title ) {
		...
		<nav class="amc-admin-tabs" aria-label="KCharts wp-admin Control Pages">
	...
	private static function render_setup_panel( $wp_admin, $title, $copy ) {
		...
		echo '</div>';
		if ( $status['is_ready'] ) {
			echo '<p>KCharts is operationally ready: charts exist, scoring has been configured, uploads have been processed, and at least one live week is already published.</p>';
		} elseif ( $wp_admin ) {
